...
NAME_GENDER = {
    ...
    "zekir": "M",
    "zlatko": "M",
    # Ergänzt 2026-09-24 für die Uni-Wien-Personalliste; mehrdeutige Vornamen
    # (Aiko, Alexis, Chris, Luca, Mischa, Sascha, Michal, …) bleiben bewusst offen.
    "agnes": "W",
    "agnethe": "W",
    "aikaterini": "W",
    "ailsa": "W",
...
def stage6_openalex(data, dry=False):
    ...
    for d in data:
        ...
        if r.get("herkunft_verified") and hk:
            ...
            d["herkunft_institution"] = r.get("herkunft_institution")
            d["herkunft_land"] = r.get("herkunft_land")
        elif hk and not d.get("herkunft_institution") and hk == existing:
            d["herkunft_institution"] = r.get("herkunft_institution")
